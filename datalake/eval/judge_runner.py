...
tests/fixtures/eval/canonical_pair.json and assert "Datalake wins, methodology delta ≥ +2".
...
from datalake.prompts.templates import JudgeOutput
...
async def run_judge(run_id: str, judge: JudgeClient) -> None:
    ...
    Blinding map (eval_pairs.a_is_datalake) is NOT shown to the judge.
    """
