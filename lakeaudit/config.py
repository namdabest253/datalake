...
class Paths(BaseModel):
    sqlite_db: Path = Path("./.lakeaudit/lakeaudit.db")
    logs_dir: Path = Path("./.lakeaudit/logs")
    heuristics: Path = Path("./lakeaudit/prompts/heuristics.yaml")
    judge_rubric: Path = Path("./lakeaudit/eval/judge_rubric.yaml")
